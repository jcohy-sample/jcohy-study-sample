...
public class SimplefactoryDemo {
	...
	public static void main(String[] args) {
		...
		// 反射的利用
		// Shape
		// shape1=sf.getshape("com.jcohy.designpattern.Factory.SimpleFactory.Circle");
		// shape1.draw();

		Properties pro = new Properties();
		File file = new File(
				"D:\\workspace\\IdeaWorkSpace\\jcohy-study-sample\\jcohy-study-designpattern\\src\\main\\resources\\shape.properties");
