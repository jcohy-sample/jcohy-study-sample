...
/**
 * @author jcohy Proxy.newProxyInstance(ClassLoader loader, Class<?>[] interfaces,
 * InvocationHandler handler) loader:一个ClassLoader对象，定义了由哪个ClassLoader对象来对生成的代理对象进行加载
...
public class TestDynamicSubject {
	...
	public static void main(String[] args) {
		...
		Subject sub = (Subject) Proxy.newProxyInstance(clazz.getClassLoader(), realsubject.getClass().getInterfaces(),
				handler);
