...
/**
 * Created by jcohy on 2018/9/5. ClassName : com.jcohy.study.java8.stream Description :
 */
public class TestStream4 {

	List<Employee> emps = Arrays.asList(new Employee(102, "李四", 79, 6666.66, Employee.Status.BUSY),
	...
	public void test1() {
		...
		Arrays.stream(arrays).map((x) -> x * x).collect(Collectors.toList()).forEach(System.out::println);
	}
