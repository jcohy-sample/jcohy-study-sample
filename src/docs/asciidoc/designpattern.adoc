...
image::http://study.jcohy.com/images/design-overview.png[]
...
image::http://study.jcohy.com/images/design-structure.png[]

策略模式、模板方法模式、观察者模式、迭代子模式、责任链模式、命令模式、备忘录模式、状态模式、访问者模式、中介者模式、解释器模式。大致分为四类关系:

image::http://study.jcohy.com/images/design-real.png[]
