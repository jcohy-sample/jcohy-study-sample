...
func BubbleSort(arr *[5]int){
	fmt.Println("排序前 arr=",*arr) // 排序前 arr= [2 32 12 34 55]
	...
	fmt.Println("排序后 arr=",*arr) // 排序后 arr= &[2 12 32 34 55]
}
...
func main(){
	...
	BubbleSort(&arr)
	fmt.Println("main arr=",arr) //main arr= [2 12 32 34 55]
}
----
...
[source,go,indent=0,subs="verbatim,quotes",role="secondary"]
----
include::{go-code}/chapter20/quicksort/main.go[tag=code]
----
...
[source,go,indent=0,subs="verbatim,quotes",role="secondary"]
----
include::{go-code}/chapter20/insertsort/main.go[tag=code]
----
...
[source,go,indent=0,subs="verbatim,quotes",role="secondary"]
----
include::{go-code}/chapter20/selectsort/main.go[tag=code]
----
